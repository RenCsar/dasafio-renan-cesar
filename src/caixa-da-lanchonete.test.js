...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['com código e quantidade válidos', 'dinheiro', 'R$ 14,63', ['cafe,1', 'suco,2']],
        ['com código e quantidade válidos', 'credito', 'R$ 15,86', ['cafe,1', 'suco,2']],
        ['com código e quantidade válidos', 'debito', 'R$ 15,40', ['cafe,1', 'suco,2']],
        ['com itens inexistentes', 'dinheiro', 'Item inválido!', ['chocolate,1', 'sanduiche,2']],
        ['de múltiplas quantidades', 'dinheiro', 'R$ 33,73', ['cafe,4', 'sanduiche,3', 'queijo,2']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});